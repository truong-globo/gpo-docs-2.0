...
<details>
<summary>No prices are shown next to my options</summary>

Check **Show add-on for inputs** and **Show add-on for options** — one covers input types, the other selection types.
</details>

<details>
<summary>The product price does not change as customers choose</summary>

**Add add-on price to the product price** is off. With it off the add-on is shown separately instead of being folded into the displayed price.
</details>

<details>
<summary>The product price is higher than advertised on page load</summary>

An option with a priced **default value**, combined with the setting above. Remove the default, or make it the free value.
</details>

<details>
<summary>The label format is not applying</summary>

Make sure it contains `{{addon}}` — without it there is nowhere for the amount to go.
</details>

<details>
<summary>The currency code is missing or unwanted</summary>

Switch **Add-on money format** between **Without currency** and **With currency**.
</details>

<details>
<summary>Prices show on the product page but the cart total is different</summary>
