...
The linked product was deleted in Shopify. Select a different product, or recreate it.
</details>

<details>
<summary>"This variant does not exist on your store anymore. Please select another."</summary>

The variant was deleted or changed. Reopen the dialog and pick a current variant.
</details>

<details>
<summary>The add-on price is not what I expected</summary>

You have probably linked the wrong variant. Reopen the dialog and check which variant is selected — the price comes from it, not from the product.
</details>

<details>
<summary>The add-on shows as out of stock unexpectedly</summary>

The linked variant is out of stock, even if other variants of that product are not. Check the variant, and see [Stock and inventory](stock-and-inventory.md).
</details>

<details>
<summary>I cannot find my product in the search</summary>

Search by an exact word from the title. If it is a draft product it can still be linked, but a draft product cannot be purchased on the storefront.
</details>
