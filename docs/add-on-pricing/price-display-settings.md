...
The wording of the **add-on message** is set separately, and can be edited for each storefront language under **Settings > Translations**. See [Translate widget text](../translations-and-languages/translate-widget-text.md).
