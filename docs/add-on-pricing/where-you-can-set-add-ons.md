...
Place the priced Switch **above** the unpriced option, then use [conditional logic](../conditional-logic/conditional-logic.md) to display the date picker or upload field when the switch is on.
{% endstep %}
