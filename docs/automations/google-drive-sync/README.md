...
* Automations may not be available on all plans. See [Compare plans](../../plans-and-billing/compare-plans.md).
...
* Files are copied, not moved. They remain available from the order in Shopify admin. See [Show options on orders](../../storefront-display-and-design/show-options-on-orders/).
