...
The **Sync history** link on the [Google Drive sync](./) page opens a record of every file the workflow has handled. Use it to confirm an order's files arrived, and to retry the ones that did not.
