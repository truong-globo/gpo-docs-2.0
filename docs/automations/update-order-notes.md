...
Editing your templates directly gives you more control over where the options appear. See [Show options on orders](../storefront-display-and-design/show-options-on-orders/).
