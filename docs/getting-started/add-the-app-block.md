...
Stick with **automatic placement** if one of the built-in positions already places the widget where you want it. See [Widget placement](../storefront-display-and-design/widget-placement.md).
