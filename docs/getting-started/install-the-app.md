...
{% hint style="info" %}
Choosing the free plan does not lock you in. You can start a trial or upgrade at any time from **Pricing** — see [Change your plan](../plans-and-billing/change-your-plan.md).
{% endhint %}
{% endstep %}
