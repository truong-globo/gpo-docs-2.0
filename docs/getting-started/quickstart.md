...
You can move the widget to another position on the product detail page, and restyle it to match your theme — see [Widget placement](../storefront-display-and-design/widget-placement.md) and [Match your theme style](../storefront-display-and-design/match-your-theme-style.md).
