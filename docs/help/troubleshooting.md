---
description: >-
  Fixes for the most common reasons options are not showing up or not working as
  expected.
icon: wrench
---
...
There are three likely causes: [conditional logic](../conditional-logic/conditional-logic.md) is hiding them, the **Hide** action is applied to them, or your plan does not include those option types, so they are configured but not displayed.
...
Your template is printing every property, including the app's internal ones. The snippet in [Show options on orders](../storefront-display-and-design/show-options-on-orders/) skips property names beginning with an underscore.
...
Turn on **Match theme style** in **Settings** > **Design**, and check whether your theme is listed under the **View supported themes** link beside it. If it is not listed, set the colors, borders, and fonts manually. See [Match your theme style](../storefront-display-and-design/match-your-theme-style.md).
...
Change **Widget placement** in **Settings** > **Settings** > **General**, or set the position exactly with an [app block](../getting-started/add-the-app-block.md). See [Widget placement](../storefront-display-and-design/widget-placement.md).
...
The feature is not included on your current plan. See [Compare plans](../plans-and-billing/compare-plans.md).
...
* [Troubleshooting personalizer](../product-personalizer/troubleshooting.md) covers nothing being drawn, an incorrect position, the wrong font, and unusable customer designs.
