...
Because you created the element, a builder update cannot rename it. See [Widget placement](../storefront-display-and-design/widget-placement.md).
{% endstep %}
