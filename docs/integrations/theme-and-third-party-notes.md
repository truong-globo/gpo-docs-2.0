...
These apps usually appear near the buy button, where the widget is. If they overlap, change the [widget placement](../storefront-display-and-design/widget-placement.md) or set the position with an [app block](../getting-started/add-the-app-block.md).
