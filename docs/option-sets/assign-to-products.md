...
* **Automatic Rules** and **Apply to All Products** may be restricted on some plans. If a switch is unavailable, see [Compare plans](../plans-and-billing/compare-plans.md).
