...
**Before you start:** Make sure the app is installed and you’ve chosen a plan ([Install the app](../getting-started/install-the-app.md)). If you’re not sure which options to offer your customers yet, browse [Option types](../option-types/option-types.md) or start with a [template](../templates/templates.md).
...
The other option, **Use a template**, creates a copy of a complete option set that you can then edit — see [Templates](../templates/templates.md).
...
{% hint style="warning" %}
Selecting **Point of Sale** is not enough on its own. Some option types and one add-on mode are not supported on POS. See [POS limitations](../point-of-sale/limitations.md).
{% endhint %}
{% endstep %}
