...
The slider colors are set store-wide under **Settings > Design**: **Range slider thumb**, **Range slider background**, and **Range slider active background**. See [Colors](../../storefront-display-and-design/colors.md).
