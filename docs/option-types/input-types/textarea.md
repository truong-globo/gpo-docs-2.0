...
See [Text layers](../../product-personalizer/layer-settings/text-layers.md) and [Position, size, and rotation](../../product-personalizer/layer-settings/position-size-rotation.md).
