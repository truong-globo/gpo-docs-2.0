...
Settings are **Image shape**, **Background mode**, width, height, position, opacity, rotation, clip area, and customer controls. See [Image layers](../../product-personalizer/layer-settings/image-layers.md).
