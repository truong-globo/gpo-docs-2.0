...
For full detail, see [Conditional logic](../../conditional-logic/conditional-logic.md), the [operators reference](../../conditional-logic/operators-reference.md), and [conditions based on Shopify variants](../../conditional-logic/conditions-on-shopify-variants.md).
