...
* The font comes from your typography settings. Only the color can be set here. See [Borders and typography](../../storefront-display-and-design/borders-and-typography.md).
