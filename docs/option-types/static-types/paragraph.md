...
<figure><img src="../../.gitbook/assets/2026-09-03_15-23-36.png" alt="A formatted paragraph on a storefront product page above a group of options"><figcaption><p>A paragraph is for what the customer must read, not what they might want to.</p></figcaption></figure>
...
The editor supports bold, italics, lists, links, and alignment. It is the same editor used by [Pop-up modal](pop-up-modal.md) and [Tabs](tabs.md).

## Paragraph, help text, or modal?

All three can hold an explanation, so use this table to decide between them.

<table><thead><tr><th width="200">Use</th><th width="230">When the text is</th><th>Because</th></tr></thead><tbody><tr><td><a href="../shared-settings/placeholder-and-help-text.md#help-text">Help text</a></td><td>One line, about one field</td><td>It sits with the field it explains</td></tr><tr><td><strong>Paragraph</strong></td><td>One to three sentences, about a group</td><td>It reads as page content, and can be formatted</td></tr><tr><td><a href="pop-up-modal.md">Pop-up modal</a></td><td>Longer than that, and most customers will skip it</td><td>It keeps the page short</td></tr></tbody></table>

{% hint style="warning" %}
Keep paragraphs short. Every line pushes the **Add to cart** button further down the page. If your text is longer than three or four sentences, use a pop-up modal or [Tabs](tabs.md).
{% endhint %}

## Examples

**A lead-time note above the personalization fields**

> **Personalized items take 3–5 working days to make**, on top of delivery time. They cannot be returned unless faulty.

**A conditional warning**

A paragraph explaining that engraved items cannot be returned, displayed by conditional logic once the customer has entered something in the engraving field.
...
* Paragraphs can be translated for each storefront language, like other option content. See [Translate option content](../../translations-and-languages/translate-option-content.md).
* Formatting comes from the editor. Use [HTML](html.md) for anything the editor does not support.
