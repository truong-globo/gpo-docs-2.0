...
* Titles and content can be translated for each storefront language. See [Translate option content](../../translations-and-languages/translate-option-content.md).
* Tab colors are store-wide. Set **Tab title**, **Tab title active**, **Tab title hover**, **Tab content**, and **Tab border** in **Settings > Design**. See [Colors](../../storefront-display-and-design/colors.md).
