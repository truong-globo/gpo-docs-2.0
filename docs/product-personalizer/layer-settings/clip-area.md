...
<figure><img src="../../.gitbook/assets/person9.png" alt="The clip area settings with the region outlined on the product preview"><figcaption><p>The clip area is visible while you position it, and can be hidden from customers.</p></figcaption></figure>
