...
<figure><img src="../../.gitbook/assets/person8.png" alt="The Curve slider with the preview text bent along an arc on the product photo"><figcaption><p>Curve is what makes text on a mug or a ring look printed rather than pasted on.</p></figcaption></figure>
