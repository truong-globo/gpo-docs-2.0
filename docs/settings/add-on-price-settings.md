---
description: >-
  The Add-on price section, covering how extra charges are displayed and how
  add-on lines appear in the cart.
icon: tags
---

# Add-on price settings

**Settings** > **Settings** > **Add-on price** contains seven store-wide settings that control how add-on charges are _displayed_. The amounts charged are set on the options themselves.
...
<table><thead><tr><th width="290">Setting</th><th>Where it is</th></tr></thead><tbody><tr><td>The price itself</td><td>On each option, or each option value. See <a href="../add-on-pricing/where-you-can-set-add-ons.md">Where you can set add-ons</a></td></tr><tr><td>How a charge scales with quantity</td><td>The option's <strong>Add-on quantity</strong>. See <a href="../add-on-pricing/advanced-add-on-modes.md">Advanced add-on modes</a></td></tr><tr><td>The add-on message's wording</td><td><strong>Settings > Translations</strong>, per language</td></tr><tr><td>Cart controls for add-on lines</td><td><strong>Settings > General > Cart page</strong>. See <a href="../storefront-display-and-design/cart-page.md">Cart page</a></td></tr></tbody></table>
