...
Many fonts do not include Arabic, Hebrew, Thai, or CJK glyphs, and missing glyphs fall back to a system font. See [Right-to-left and non-Latin text](../translations-and-languages/rtl-and-non-latin.md).
{% endstep %}
...
* The Personalizer's fonts are set per layer and are separate from these. See [Fonts](../product-personalizer/layer-settings/fonts.md).
