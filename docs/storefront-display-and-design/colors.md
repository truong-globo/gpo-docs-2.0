---
description: Every color setting in the widget, grouped as the app groups them.
icon: palette
---
...
On a supported theme, it sets most of these colors at once. See [Match your theme style](match-your-theme-style.md).
{% endstep %}
...
* These settings are store-wide. There is no per-option-set color scheme. To style one option set differently, use an [HTML class](../option-types/shared-settings/direction-width-and-css.md#html-class) and [custom CSS](custom-css.md).
