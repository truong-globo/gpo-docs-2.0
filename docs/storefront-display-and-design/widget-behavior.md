...
**Right to left** changes the layout of the entire widget, not just the text alignment. See [Right-to-left and non-Latin text](../translations-and-languages/rtl-and-non-latin.md).
