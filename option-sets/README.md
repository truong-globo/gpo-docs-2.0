...
* [Create an option set](create-an-option-set.md)
* [Option types](../option-types/README.md) — what you can put inside one.
* [Templates](../templates/README.md) — start from a ready-made set instead.
