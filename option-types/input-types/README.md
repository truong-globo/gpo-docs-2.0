---
description: >-
  The 12 option types where the customer enters a value instead of choosing from a
  list.
icon: keyboard
---
...
{% hint style="info" %}
Some types cannot have a price, such as a date field used for a delivery fee. Add the charge to a separate [Switch](switch.md) or [Checkbox](../selection-types/checkbox.md), and use [conditional logic](../../conditional-logic/README.md) to display the field when it is needed.
{% endhint %}

## Choosing between them

For comparisons between similar types, such as Text and Textarea, Number and Range slider and Dimension, or Switch and a single Checkbox, see [Choose the right option type](../choose-the-right-type.md).
