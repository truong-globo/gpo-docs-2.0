...
* [Radio button](radio-button.md) — one choice instead of several.
* [Advanced add-on modes](../../add-on-pricing/advanced-add-on-modes.md) — especially Mixed quantity.
* [Limits](../shared-settings/limits.md#min-and-max-selections)
