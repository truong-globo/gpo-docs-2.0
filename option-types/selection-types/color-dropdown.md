...
* [Color swatch](color-swatch.md) — the grid alternative.
* [Image dropdown](image-dropdown.md) — the same idea with pictures.
* [Swatch style and previews](../shared-settings/swatch-style-and-previews.md)
