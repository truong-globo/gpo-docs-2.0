...
* [Image swatch](image-swatch.md) — pictures instead of colours.
* [Color dropdown](color-dropdown.md) — the compact alternative.
* [Collapsible layouts and sliders](../shared-settings/collapsible-layouts-and-sliders.md)
