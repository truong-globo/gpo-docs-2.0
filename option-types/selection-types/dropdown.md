...
* [Color dropdown](color-dropdown.md) and [Image dropdown](image-dropdown.md) — the same idea, specialised.
* [Selection behaviour](../shared-settings/selection-behaviour.md)
