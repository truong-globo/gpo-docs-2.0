...
* [Dropdown](dropdown.md) — the fuller version.
* [Working with option values](../../concepts/option-values.md)
* [Choose the right option type](../choose-the-right-type.md)
