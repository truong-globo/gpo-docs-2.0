...
<details>
<summary>I cannot find Layout type or the slider settings</summary>

Turn on **Enable custom layout** first. And check the type — **Slider** is only on Button, Color swatch, and Image swatch.
</details>

<details>
<summary>Slider is missing from Layout type</summary>

Either you are on Checkbox or Radio button, which do not offer it, or the slider layout is not included in your plan.
</details>

<details>
<summary>Scroll type has disappeared</summary>

You selected **Slider** as the layout type. Scrolling applies to the Expand and Collapse layouts only.
</details>

<details>
<summary>Slider style does nothing</summary>

It only appears and applies once **Show navigation arrows** is set to **Show** — the styles are arrow designs.
</details>

<details>
<summary>Shoppers say they cannot see all the choices</summary>

Turn on **Show navigation arrows** or **Show indicators**, or lower **Swatches per row** so a partial swatch shows at the edge.
</details>

<details>
<summary>The layout looks wrong on mobile</summary>
