...
<details>
<summary>My values table has no Color or Image column</summary>

**Swatch style** is set to **Default**. Change it to **Color** or **Image** and the column appears.
</details>

<details>
<summary>I set Swatch style to Image but the swatches are blank</summary>

The values have no images yet. Upload one per value in the **Image** column, or reuse a product image.
</details>

<details>
<summary>Swatch image width and height do nothing</summary>

They exist on **Image swatch** only. On other types showing images, size follows the type's own layout.
</details>

<details>
<summary>No tooltip appears on hover</summary>

Check two things: **Show tooltip when hovering over options** in **Settings > Settings > General**, and that you are not on a touch device, where hover behaves differently.
</details>

<details>
<summary>The zoomed tooltip image is blurry</summary>

The uploaded file is smaller than the tooltip size. Upload a larger image, or reduce **Tooltip image width** and **Tooltip image height**.
</details>
