...
This is intentional, so that option forms look the same across your store. To style one option set differently, add an [HTML class](../option-types/shared-settings/direction-width-and-css.md#html-class) to the option and target it with [custom CSS](../storefront/custom-css.md).
