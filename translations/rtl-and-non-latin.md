...
{% hint style="warning" %}
Alignment is **store-wide**. If you sell in both a left-to-right and a right-to-left language, you cannot set alignment per language here. Use [custom CSS](../storefront/custom-css.md) based on your theme's own language markers instead.
{% endhint %}
