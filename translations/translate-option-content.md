...
<details>
<summary>There is no language switcher in the builder</summary>

Either your storefront has only one language, or multi-language option content is not in your plan.
</details>

<details>
<summary>I translated the label but the cart is still in English</summary>

The cart shows the **Name**, which is not translatable. This is by design.
</details>

<details>
<summary>My conditional rule works in one language but not another</summary>

A variant condition. Switch language in the builder and enter the translated variant name.
</details>

<details>
<summary>Some text is still in my primary language on the translated storefront</summary>

That text has no translation yet, so it falls back. Switch to that language in the builder and fill it in.
</details>

<details>
<summary>I overwrote my original text</summary>

You were on your primary language rather than the translation. Switch language first, then edit.
</details>

<details>
<summary>Error messages are not translated</summary>
